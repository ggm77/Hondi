  ...
  return `
    <div class="onboarding">
      ...
      <div class="onboarding-hero" style="position:relative">
        ...
        <h1 class="onboarding-title" style="line-height:1.04;margin:14px 0 10px">혼디<br>가게</h1>
        <p class="onboarding-lead" style="line-height:1.5;margin:0;max-width:250px">제주도 여행,<br>택시비도 같이 나눠요</p>
        <p style="font-size:12px;color:var(--color-neutral-700);margin:10px 0 0">'혼디'는 제주말로 함께라는 뜻이에요.</p>
      </div>

      <div class="onboarding-steps" style="position:relative;display:flex;flex-direction:column;gap:14px">
        ${[
